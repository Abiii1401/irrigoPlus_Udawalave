      ...
      <div className="flex flex-col items-center space-y-12 relative z-10">
        ...
        <div className="relative w-48 h-48">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative">
              ...
              <div
                className="absolute -bottom-1 -left-1 w-2 h-2 rounded-full bg-blue-500 animate-pulse"
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div
              className="w-1 h-32 bg-gradient-to-b from-transparent via-blue-400/30 to-transparent animate-rotate"
        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <div
              className="w-2 h-2 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 animate-pulse shadow-lg"
          ...
          <p className="text-sm text-slate-600 animate-pulse">
            Initializing IrrigoPlus+ platform
          </p>
        </div>
